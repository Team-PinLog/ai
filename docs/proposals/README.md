...
| P41 | 툴체인 — Python 3.12 통일·pgvector `0.8.5-pg16`+digest 고정(최초 `0.8.1-pg16` → Jira 작업에서 운영·back 실제 버전에 정합)·requirements lock | AI | [implements](../implements/2026-07-24-e3-test-harness.md) (ai#14·#16) |
