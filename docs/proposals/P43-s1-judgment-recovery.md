...
| 9 | "pgvector 0.8.1 = back과 일치" → 무효화, 0.8.5+digest 권고 | back#31이 compose를 올림. 조사 끝에 digest까지 동일 고정을 권고했으나 **값 변경은 하지 않고 종료** → 권고는 `S15P11A705-122`에서 반영(`0.8.5-pg16`+digest) |
